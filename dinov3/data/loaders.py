...
from .datasets import ADE20K, CocoCaptions, ImageDirectory, ImageNet, ImageNet22k, NYU
...
def _parse_dataset_str(dataset_str: str):
    ...
    if name == "ImageNet":
        ...
        class_ = ImageDirectory
        if "extra" in kwargs or "split" in kwargs:
            raise ValueError("ImageDirectory only accepts the root parameter")
